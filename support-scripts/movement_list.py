...
game = os.path.expanduser("~/.local/share/Steam/steamapps/common/Victoria 3/game/common/political_movements/")
...
with open('better-politics-mod/common/scripted_effects/bpm_movement_setter.txt', 'w', encoding='utf-8') as file:
